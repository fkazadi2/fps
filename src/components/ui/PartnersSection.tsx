...
const partners = [
  {
    id: 1,
    name: "AMT RDC",
    logo: "/images/logos/amt-rdc.jpg",
    url: "http://www.amtpharma.cd/",
  },
  {
    id: 2,
    name: "CAMESKIN",
    logo: "/images/logos/logocameskin.png",
    url: "https://cameskin-asbl.org/about",
  },
  {
    id: 3,
    name: "MARIANEPHAR",
    logo: "/images/logos/Mariaphar.png",
    url: "https://marianephar.net/",
  },
  {
    id: 4,
    name: "Saint Sauveur",
    logo: "/images/logos/header-logo-saint-sauveur-2.png",
    url: "https://saintsauveurpharm.com/",
  },
  {
    id: 5,
    name: "PHATKIN",
    logo: "/images/logos/t%C3%A9l%C3%A9chargement.jpeg",
    url: "https://www.phatkin.org/a-propos",
  },
  {
    id: 6,
    name: "Unique Pharma",
    logo: "/images/logos/images%20(9).jpeg",
    url: "https://www.uniquesarl.com/",
  },
];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center mb-16">
          ...
          <h2 className="text-4xl md:text-5xl font-extrabold text-[var(--primary)] mb-4">
            Nos partenaires EPVG
          </h2>
          <p className="mt-4 max-w-3xl mx-auto text-xl text-gray-600">
            Ensemble pour l'amélioration de la qualité de l'offre des soins et services de santé en RDC
          </p>
        </div>
